  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#fbfcff] text-ink">
      ...
      <main>
        ...
        <section className="parcel-wash-alt mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-10 xl:px-6"><div className="mx-auto flex max-w-3xl flex-col items-center gap-5 text-center sm:flex-row sm:text-left"><span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-accent-light text-accent-dark"><Smartphone size={22} /></span><div className="min-w-0 flex-1"><p className="text-[10px] font-bold uppercase tracking-[.18em] text-accent">Application mobile</p><h2 className="mt-1 text-[20px] font-black tracking-[-.025em] text-navy">Gardez STANDA à portée de main.</h2><p className="mt-1 text-[13px] leading-relaxed text-mute">Suivez vos colis et consultez vos factures depuis votre téléphone.</p></div><StoreBadges className="justify-center sm:justify-end" /></div></section>
