"use client";
/*
 * STANDA COMMERCIAL — TABLO DE BÒ ADMIN
 * ═════════════════════════════════════
 * Paj sa a te sou "/" anvan. Nou deplase l sou "/dashboard" paske rasin
 * domèn nan (standacommercialsa.com) dwe montre SIT PIBLIK la: yon kliyan
 * ki tape adrès la pa dwe tonbe sou yon ekran koneksyon staff.
 *
 * Redireksyon "/" -> "/accueil" fèt nan middleware.ts, AVAN React monte —
 * konsa pa gen okenn flash ni chajman initil.
 */
